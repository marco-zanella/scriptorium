...
def _make_collection_with_one_case(db_session: Session, username: str) -> TestCollection:
    ...
    test_case = TestCase(owner_id=user.id, content="in the beginning", language="eng", tags=[])
...
def test_run_test_collection_creates_result_case_and_marks_completed(
    ...
    collection = _make_collection_with_one_case(db_session, "runner-alice")
    ...
    def fake_search(*args, **kwargs):
        return SearchResult(took_ms=1, count=1, page=1, page_size=50, results=fake_results)
